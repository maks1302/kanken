...
// параметры запроса
$data = array(
    'key'             => '6783e879b5db4562260d08a84de877c2', //Ваш секретный токен
...
// запрос
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, 'http://kanan.lp-crm.biz/api/addNewOrder.html');
